            ...
            protected Integer call() throws Exception {
                ...
                for (int offset = 0; ; offset += 1000) {
                    ...
                    for (int i = 0; i < bindings.length(); i++) {
                        ...
                        if (aaa != null) building = aaa;
                        else building.setBuildingName(name);
                        ...
                        if (type != null) building.addType(type);
                        else building.addType(new Type(typeName));
