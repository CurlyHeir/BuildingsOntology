...
/**
 * Background service that retrieves data from DBpdia server, parses, translates with BuildingType Enum and stores
 * in database
 */
            ...
            protected Integer call() {
                try (Session session = SessionFactory.getSession()) {
                    ...
                    for (int offset = 0; errorCounter < 5; ) {
                        ...
                        System.out.println("offset: " + offset + "errors: " + errorCounter);
                        offset += 1000;
                    }
                }
                return null;
